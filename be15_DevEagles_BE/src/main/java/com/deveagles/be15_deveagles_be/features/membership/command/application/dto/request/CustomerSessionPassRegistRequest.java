...
@Setter
@NoArgsConstructor
public class CustomerSessionPassRegistRequest {

  @NotNull(message = "고객ID는 필수입니다.") private Long customerId;

  @NotNull(message = "선불권ID는 필수입니다.") private Long sessionPassId;

  @NotNull(message = "충전금액은 필수입니다.") private Integer remainingCount;
