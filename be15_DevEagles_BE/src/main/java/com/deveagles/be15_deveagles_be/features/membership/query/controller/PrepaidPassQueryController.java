...
public class PrepaidPassQueryController {
  ...
  @GetMapping
  public ResponseEntity<ApiResponse<List<PrepaidPassResponse>>> getPrepaidPasses(
      @AuthenticationPrincipal CustomUser user) {
    List<PrepaidPassResponse> result = prepaidPassQueryService.getAllPrepaidPass(user.getShopId());
