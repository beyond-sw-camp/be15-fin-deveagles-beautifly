...
import static com.deveagles.be15_deveagles_be.features.coupons.entity.QCoupon.coupon;
...
public class CouponQueryRepositoryImpl implements CouponQueryRepository {
  ...
  @Override
  public Page<Coupon> searchCoupons(CouponQuery query, Pageable pageable) {
    log.info(
  ...
  private com.querydsl.core.types.OrderSpecifier<?> getOrderSpecifier(CouponQuery query) {
