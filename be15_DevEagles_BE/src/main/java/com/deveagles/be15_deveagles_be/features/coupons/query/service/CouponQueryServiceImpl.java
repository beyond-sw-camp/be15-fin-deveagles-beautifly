...
public class CouponQueryServiceImpl implements CouponQueryService {
  ...
  @Override
  public PagedResult<CouponResponse> searchCoupons(CouponQuery query) {
    log.info(
    ...
    Page<com.deveagles.be15_deveagles_be.features.coupons.entity.Coupon> coupons =
        couponRepository.searchCoupons(query, pageable);
